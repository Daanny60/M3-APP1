...
{
    (void)Com_ReceiveSignal(COM_RX_SIG2, &u8EngineState);
}
///////////////////////////////////////////////////////////////////////////////////////////
void AppRxIpdu_Message1_TimeOutProcess(void) {
    u8heatcmddata = 0x0;
    rx_timeout_flag |= (1u << COM_RXIPDU_Message1);
}

void AppRxIpdu_Message2_TimeOutProcess(void) {
    u8EngineState = 0x0;
    rx_timeout_flag |= (1u << COM_RXIPDU_Message2);
}
...
{
    //如果u8EngineState== 0x1 则u8HeatEnableCondition为1否则为0
    if(u8EngineState == 0x1)
    {
