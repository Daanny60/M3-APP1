...
void AppDemm_BCM_Timeout_Failure_Event_Set(DemmDtcEvent_e event)
{
    Event.AppDemmEvent.BCM_Timeout_FailureEvent = event;
}
...
DemmDtcEvent_e AppDemm_BCM_Timeout_Failure_Event_Get(void)
{
    DemmDtcEvent_e event;
    event = Event.AppDemmEvent.BCM_Timeout_FailureEvent;
    Event.AppDemmEvent.BCM_Timeout_FailureEvent = DTC_TEST_EVENT_NULL;
    return (event);
}
DemmDtcEvent_e AppDemmHeatOpenFailureEventGet(void)
{
