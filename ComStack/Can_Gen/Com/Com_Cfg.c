...
#if(COM_RXIPDUNUM>=1)
RxIpdu_Message1_bufType  RxIpdu_Message1;//0X2CD

RxIpdu_Message2_bufType RxIpdu_Message2;//0X117
...
COM_CONST COM_IpduRxTimeOut_Struct COM_IpduRxTOTimerTable[COM_RXIPDUNUM] = {
    ...
    {1u, COM_RXTIMEOUTMONITOR_YES, 250u},  //117   10ms   10*cycle=100
};
...
uint8_t  rx_timeout_cnt[COM_RXIPDUNUM];
