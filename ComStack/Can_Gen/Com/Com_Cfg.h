...
/******************************************************************************/
#define COM_TXIPDU_Message1          0u //0x36A
...
/******************************************************************************/   
#define COM_RXIPDU_Message1                  0u //0X2CD SteerWhllHeatSW_BCM
#define COM_RXIPDU_Message2                  1u //0X117 EngState_EMS
...
/******************************************************************************/   
#define COM_RXSIGNUM	 2u
/******************************************************************************/   
/* Handles of receive signals                                                 */
/******************************************************************************/   
#define  COM_RX_SIG1                   0u//0X2CD SteerWhllHeatSW
#define  COM_RX_SIG2                   1u//0X117 EngState
...
/********************************************************************************/   
typedef union {
RxIpdu_Message1_Type Rx_Message1;
  COM_UINT8 _c[8];
}RxIpdu_Message1_bufType;

typedef union {
RxIpdu_Message2_Type Rx_Message2;
  COM_UINT8 _c[8];
...
#define COM_RXIPDU_Message1_TIMEOUTFLAG    (1 << COM_RXIPDU_Message1)
#define COM_RXIPDU_Message2_TIMEOUTFLAG    (1 << COM_RXIPDU_Message2)
extern uint8_t  rx_timeout_flag;
extern uint8_t  rx_timeout_cnt[COM_RXIPDUNUM];
#endif

/******************************************************************************/   
/*rx Ipdu timeout indication function definition    M3                  */
/******************************************************************************/   
