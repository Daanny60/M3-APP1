...
static CONST(DcmDsdServiceTable, DCM_VARIABLE)   gServiceTable_1[DCM_NUM_OF_SERVICE]=
{
    ...
    { DCM_DSDSIDTABID,{&DspInternal_Uds_ClearDiagnosticInformation,      UDS_SERVICE_WITHOUT_SUB_FUNCTION,(DCM_SEC_LEV_LOCK|DCM_SEC_LEV_L1),(DCM_SESSION_DEFAULT|DCM_SESSION_EXTENDED_DIAGNOSTIC) },
    ...
    { DCM_DSDSIDTABID,{&DspInternal_Uds_ReadDTCInformation,              UDS_SERVICE_WITH_SUB_FUNCTION,   (DCM_SEC_LEV_LOCK|DCM_SEC_LEV_L1),(DCM_SESSION_DEFAULT|DCM_SESSION_EXTENDED_DIAGNOSTIC) }, 
    ...
    { DCM_DSDSIDTABID,{&DspInternal_Uds_WriteDataByIdentifier,           UDS_SERVICE_WITHOUT_SUB_FUNCTION,(DCM_SEC_LEV_LOCK|DCM_SEC_LEV_L1),(DCM_SESSION_EXTENDED_DIAGNOSTIC)},  //programming?
...
/*配置安全等级等的服务在这里配置*/
CONST(DcmDsdSubService, DCM_VARIABLE)
gDcmDsdSubService[DCM_NUM_OF_SUB_SERVICE] =
    {
#if (DCM_SERVICE_10_ENABLED == STD_ON)
