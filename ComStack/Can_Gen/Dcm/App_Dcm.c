...
uint8_t ECU_SW_Number[16] = "3402929V03XU00  ";

// F192	SupplierECUHardware Number
uint8_t ECU_HD_Number[15] = "TQ04M301HW1.0  ";
...
uint8_t Supplier_ECU_Hardware_Version[5] = {'V', '1', '.', '0', '0'};
...
boot_read_data_add_s boot_read_data_add = {(uint8_t *)0x00007FD0, (uint8_t *)0x00007FF0, (uint8_t *)0x00007FE0};
...
#define ReadHandle_0xF300 19u
#define ReadHandle_0xF301 19u
#endif
/* For 0x27 */
...
uint8 Service02_SID02DTC[2] = {0x01, 0x00};
#endif
...
uint8 DTCStatus[NUM_OF_DTC] = {0x08};
/* For 0x22 */
uint8 DATA_0xF18C[17];
uint8 DATA_0xF187[16];
uint8 DATA_0xF18A[5];
uint8 DATA_0xF193[5];
uint8 DATA_0xF195[5];
...
uint8 DATA_0xF190[17] = {
    0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47, 0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39
};
uint8 DATA_0xF199[4] = {0x07, 0xE8, 0x08, 0x01};
uint8 DATA_0xF19D[4] = {0x07, 0xE8, 0x09, 0x01};
uint8 DATA_0xF1A8[20] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
    };
uint8 DATA_0xF183[16];
uint8 DATA_0xF184[9];
uint8 DATA_0xF186[1];
uint8 DATA_0xF188[16];
uint8 DATA_0xF189[5];
uint8 DATA_0xF18B[4];
 ...
 ******************************************************************************/
FUNC(void, DCM_CODE)
App_Default(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint32 tempP2Star;
    /* Step 1:Transmit positive response*/
    if (GetSuppressPosResponseBit() == 0) {
        /* If positive response is supressed, dont' need make it */
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_DefaultPost(Std_ReturnType Result) {
    uint8 i = 0;
    // 检查结果是否为 E_OK
    if (Result == E_OK) {
        // 设置会话控制为默认会话
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_Programming(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    /// uint32 tempP2Star;
    /* Step 1:Transmit positive response*/
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_ProgrammingPost(Std_ReturnType Result) {
    /// uint8 i=0;
    if (Result == E_OK) {
        #if 0
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_Extended_Diagnostic(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint32 tempP2Star;
    /* Step 1:Transmit positive response*/
    if (GetSuppressPosResponseBit() == 0) {
        /* If positive response is supressed, dont' need make it */
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_Extended_DiagnosticPost(Std_ReturnType Result) {
    uint8 i = 0;
    if (Result == E_OK) {
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_Kuwe_Session(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint32 tempP2Star;
    /* Step 1:Transmit positive response*/
    if (GetSuppressPosResponseBit() == 0) {
        /* If positive response is supressed, dont' need make it */
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_Kuwe_SessionPost(Std_ReturnType Result) {
    uint8 i = 0;
    if (Result == E_OK) {
 ...
 ******************************************************************************/
FUNC(void, DCM_CODE)
App_HardReset(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    pMsgContext->resDataLen = 2;
    DsdInternal_ProcessingDone(pMsgContext);
}
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_HardResetPost(Std_ReturnType Result) {
    uint8 i = 0;
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_SoftReset(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    pMsgContext->resDataLen = 2;
    DsdInternal_ProcessingDone(pMsgContext);
}
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_SoftResetPost(Std_ReturnType Result) {
    uint8 i = 0;
 ...
 ******************************************************************************/
FUNC(void, DCM_CODE)
App_ClearDiagnosticInformation(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    err_flag_e error = 0;
    uint8 dtc[3];
...
#if (0)
FUNC(void, DCM_CODE)
App_Read0x0004(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8_t buf[2];
    uint8_t i;
...
#if (0)
FUNC(void, DCM_CODE)
App_Read0x0005(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8_t buf[2];
    uint8_t i;
    // vCheckDidTask();//MODIFY
 ...
 ******************************************************************************/
FUNC(void, DCM_CODE)
App_Read0xF183(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8_t i;
    uint8_t *data;
...
#if (0)
FUNC(void, DCM_CODE)
App_Read0xF184(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8_t i;
    
    Eeprom_RamRead(&DATA_0xF184[0],
        APPLICATION_SOFTWARE_FINGERPRINT_BYTE0_EE_FLASH_RAM_ADDRESS,
        gDcmDsdSubService_22[ReadHandle_0xF184].DcmDspDataSize);
 ...
 ******************************************************************************/
FUNC(void, DCM_CODE)
App_Read0xF186(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8_t i;
    uint8_t data;
...
FUNC(void, DCM_CODE)
App_Read0xF187(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8_t i;
    uint8_t *data;
...
FUNC(void, DCM_CODE)
App_Read0xF188(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8_t i;
...
FUNC(void, DCM_CODE)
App_Read0xF189(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8_t i;
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_Read0xF18A(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8_t i;
    // uint8_t u8SupplierCode[5]={'L','7','2',0x00,0x51};// L72051  3ASCII + 2BCD
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_Read0xF18B(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8_t i;
    uint8_t *pF18Bdata;
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_Read0xF18C(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8_t i;
    uint8_t *data;
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_Read0xF190(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8_t i;
    Eeprom_RamRead(
        &DATA_0xF190[0], VIN_BYTE0_EE_FLASH_RAM_ADDRESS, gDcmDsdSubService_22[ReadHandle_0xF190].DcmDspDataSize);
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_Read0xF192(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8_t i;
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_Read0xF193(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8_t i;
    uint8_t *data;
    data = app_read_data_add.F193_hardware_version;
    #if (0)
    if (0xff == data[1]) {
        data = (uint8_t *)0x0001BC16; /////read from app
    }
    #endif
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_Read0xF194(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8_t i;
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_Read0xF195(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8_t i;
    uint8_t *data = app_read_data_add.F195_software_version;
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_Read0xF197(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8_t i;
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_Read0xF199(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8_t i;
    
    Eeprom_RamRead(
        &DATA_0xF199[0], VIN_BYTE17_EE_FLASH_RAM_ADDRESS, gDcmDsdSubService_22[ReadHandle_0xF19D].DcmDspDataSize);
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_Read0xF19D(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8_t i;
    Eeprom_RamRead(
        &DATA_0xF19D[0], VIN_BYTE21_EE_FLASH_RAM_ADDRESS, gDcmDsdSubService_22[ReadHandle_0xF19D].DcmDspDataSize);
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_Read0xF1A8(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8_t i;
    Eeprom_RamRead(
        &DATA_0xF1A8[0], VIN_BYTE25_EE_FLASH_RAM_ADDRESS, gDcmDsdSubService_22[ReadHandle_0xF1A8].DcmDspDataSize);
...
FUNC(void, DCM_CODE)
App_Read0xF300(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8_t i;
    
    memory_copys(
        &DATA_0xF300[0], Supplier_ECU_Hardware_Version, gDcmDsdSubService_22[ReadHandle_0xF300].DcmDspDataSize);
    for (i = 0; i < gDcmDsdSubService_22[ReadHandle_0xF300].DcmDspDataSize; i++) {
        pMsgContext->resData[2 + i] = DATA_0xF300[i];
    }
    #if (DCM_SERVICE_22_COMBINED_DID == STD_ON)
    DsdInternal_DidProcessingDone();
    #else
    pMsgContext->resData += (gDcmDsdSubService_22[ReadHandle_0xF300].DcmDspDataSize + 2);
    pMsgContext->resDataLen += ((uint32)gDcmDsdSubService_22[ReadHandle_0xF300].DcmDspDataSize + 2);
    DsdInternal_ProcessingDone(pMsgContext);
    #endif
}

FUNC(void, DCM_CODE)
App_Read0xF301(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8_t i;
    ...
    DsdInternal_DidProcessingDone();
    #else
    pMsgContext->resData += (gDcmDsdSubService_22[ReadHandle_0xF301].DcmDspDataSize + 2);
    pMsgContext->resDataLen += ((uint32)gDcmDsdSubService_22[ReadHandle_0xF301].DcmDspDataSize + 2);
    DsdInternal_ProcessingDone(pMsgContext);
    #endif
}
...
#if (1)
FUNC(void, DCM_CODE)
App_Read0x040E(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8_t i;
...
#if (1)
FUNC(void, DCM_CODE)
App_Read0x040F(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8_t i;
    //  uint8_t power_mode;
...
FUNC(void, DCM_CODE)
App_Read0x0410(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8_t i;
    // uint8_t power_mode;
 ...
 ******************************************************************************/
FUNC(void, DCM_CODE)
App_Write0xF190(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8 i;
    if (eeprom_write_status == FLASH_COMPLETE) {
        ...
        Eeprom_RamWrite(
            &DATA_0xF190[0], VIN_BYTE0_EE_FLASH_RAM_ADDRESS, gDcmDsdSubService_2E[WriteHandle_0xF190].DcmDspDataSize);
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_Write0xF199(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8 i;
    ...
    if (eeprom_write_status == FLASH_COMPLETE) {
        ...
        Eeprom_RamWrite(
            &DATA_0xF199[0], VIN_BYTE17_EE_FLASH_RAM_ADDRESS, gDcmDsdSubService_2E[WriteHandle_0xF199].DcmDspDataSize);
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_Write0xF19D(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8 i;
    if (eeprom_write_status == FLASH_COMPLETE) {
        ...
        Eeprom_RamWrite(
            &DATA_0xF19D[0], VIN_BYTE21_EE_FLASH_RAM_ADDRESS, gDcmDsdSubService_2E[WriteHandle_0xF19D].DcmDspDataSize);
        gMsgContextType.resDataLen = 3;
    } else {
        DsdInternal_SetNegResponse(&gMsgContextType, DCM_E_GENERALPROGRAMMINGFAILURE);
    }
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_Write0xF1A8(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8 i;
    if (eeprom_write_status == FLASH_COMPLETE) {
        ...
        Eeprom_RamWrite(
            &DATA_0xF1A8[0], VIN_BYTE25_EE_FLASH_RAM_ADDRESS, gDcmDsdSubService_2E[WriteHandle_0xF1A8].DcmDspDataSize);
        gMsgContextType.resDataLen = 3;
    } else {
        DsdInternal_SetNegResponse(&gMsgContextType, DCM_E_GENERALPROGRAMMINGFAILURE);
    }
 ...
 ******************************************************************************/
FUNC(void, DCM_CODE)
App_ReturnControlToEcu0x3901(Dcm_MsgContextType *pMsgContext) {
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_ShortTermAdjustment0x3901(Dcm_MsgContextType *pMsgContext) {
    #if 0
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_ReturnControlToEcu0x3902(Dcm_MsgContextType *pMsgContext) {
    pMsgContext->resData[4] = TEST[6];
    pMsgContext->resDataLen = 6;
    DsdInternal_ProcessingDone(pMsgContext);
}
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_ShortTermAdjustment0x3902(Dcm_MsgContextType *pMsgContext) {
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_ReturnControlToEcu0x3903(Dcm_MsgContextType *pMsgContext) {
    #if 0
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_ShortTermAdjustment0x3903(Dcm_MsgContextType *pMsgContext) {
    #if 0
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_ReturnControlToEcu0xFF00(Dcm_MsgContextType *pMsgContext) {
    u8adjustheat = 0x00;
    // pMsgContext->resData[4]=0;
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_ShortTermAdjustment0x3904(Dcm_MsgContextType *pMsgContext) {
    uint8_t ram = 0;
    u8adjustheat = 0xf0;
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_ReturnControlToEcu0x3905(Dcm_MsgContextType *pMsgContext) {
    #if 0
    /*�̵����˳���Ͽ���*/
...
FUNC(void, DCM_CODE)
App_ShortTermAdjustment0x2020(Dcm_MsgContextType *pMsgContext) {
    uint8_t ram = 0;
    u8adjustheat = 0xf0;
 ...
 ******************************************************************************/
FUNC(void, DCM_CODE)
App_ReportNumberOfDTCByStatusMask(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8 i;
    uint16 counter = 0;
    uint8 DtcStatus;
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_ReportDTCByStatusMask(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8 i;
    uint16 counter = 0;
    uint8 DtcStatus, tmp;
    DtcStatus = pMsgContext->reqData[2];
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_ReportSupportedDTC(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint32 i;
    pMsgContext->resData[2] = DTCStatusAvailabilityMask;
    for (i = 0; i < NUM_OF_DTC; i++) {
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_ReportDTCSnapshotIdentification(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8_t i;
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_ReportDTCSnapshotRecordByDTCNumber(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8 error = 0;
    uint32 Dtc;
        ...
        switch (DTCSnapshotRecordNumber) {
            ...
            case 0x01:
                ...
                if (stred_dtc_ind == DTC_NOT_STORED_FLAG) {
                    ...
                    pMsgContext->resData[10] =
                        dtc_info_struct.dtc_stored_dt[stred_dtc_ind].DTCSnapShotData[0].c_main_ecu_supply_voltage;
                    pMsgContext->resData[11] = c_dtc_snap_shot_data_id[1][0];
                    pMsgContext->resData[12] = c_dtc_snap_shot_data_id[1][1];
                    pMsgContext->resData[13] =
                        dtc_info_struct.dtc_stored_dt[stred_dtc_ind].DTCSnapShotData[0].c_main_ecu_power_mode;
                    pMsgContext->resData[14] = c_dtc_snap_shot_data_id[2][0];
                    pMsgContext->resData[15] = c_dtc_snap_shot_data_id[2][1];
                    pMsgContext->resData[16] =
                        dtc_info_struct.dtc_stored_dt[stred_dtc_ind].DTCSnapShotData[0].c_main_ecu_vehicle_speed >> 8;
                    pMsgContext->resData[17] =
                        dtc_info_struct.dtc_stored_dt[stred_dtc_ind].DTCSnapShotData[0].c_main_ecu_vehicle_speed;
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_ReportDTCExtendedDataRecordByDTCNumber(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint8 error = 0;
    uint32 Dtc;
    uint8 i, dtc_index = 0xffu;
            ...
            case 0x01:
                ...
                if (stred_dtc_ind == DTC_NOT_STORED_FLAG) {
                    ...
                    pMsgContext->resData[7] =
                        dtc_info_struct.dtc_stored_dt[stred_dtc_ind].DTCextended_data.occurrence_counter;
...
void App_ReadAddress(Dcm_MsgContextType *pMsgContext) {
    ...
    for (i = 0; i < gMemorySizeFormat; i++) {
        memorySize |= (uint32)(pMsgContext->reqData[2u + gMemoryAddressFormat + i])
            << (uint8)(8u * (gMemorySizeFormat - 1u - i));
    }
...
FUNC(void, DCM_CODE)
App_Request_Seed_L1(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    #if 1 // seed 4 bytes
    uint16 i;
    uint16 u16RandTemp;
    /// uint8_t *data;
    ...
    pMsgContext->resData[1] = pMsgContext->reqData[1];
    for (i = 0; i < gDcmDspSecurityRow[0].DcmDspSecuritySeedSize + 0; i++) {
        // 4
    ...
    pMsgContext->resData[1] = pMsgContext->reqData[1];
    for (i = 0; i < gDcmDspSecurityRow[0].DcmDspSecuritySeedSize + 4; i++) {
        // 4
        /* add user code here ,generate App Seed */
        gMsgContextType.resData[2 + i] = MagicSeed[i];
    }
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_Send_Key_L1(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    uint32 i;
    uint8 temp = 0;
    uint8 key[4];
 ...
 ******************************************************************************/
FUNC(void, DCM_CODE)
App_EnableRxAndTx(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_EnableRxAndDisableTx(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    if (gMsgContextType.reqData[2] == NORMAL_MSG) {
        Com_TxStop();
        Com_RxStart();
    } else if (gMsgContextType.reqData[2] == NM_MSG) {
...
FUNC(void, DCM_CODE)
App_DisableRxAndEnableTx(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    if (gMsgContextType.reqData[2] == NORMAL_MSG) {
        Com_TxStart();
        Com_RxStop();
    } else if (gMsgContextType.reqData[2] == NM_MSG) {
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_DisableRxAndTx(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    if (gMsgContextType.reqData[2] == NORMAL_MSG) {
        Com_TxStop();
        Com_RxStop();
    } else if (gMsgContextType.reqData[2] == NM_MSG) {
 ...
 ******************************************************************************/
FUNC(void, DCM_CODE)
App_StartRoutine0x0203(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_StartEreasememory(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    // uint8_t system_voltage_mod;
    DsdInternal_RoutineStarted();
    ...
    #else
    pMsgContext->resDataLen = 4 + DcmDspRoutineIdentifierTable_31[RoutineHandle_0xFF01]
        .DcmDspRoutineInfoRef.DcmDspStartRoutineOut.DcmDspRoutineSignalLength;
    #endif
    DsdInternal_ProcessingDone(pMsgContext);
}
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_StartCheckintegrity(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    DsdInternal_RoutineStarted();
    
    pMsgContext->resDataLen = 4 + DcmDspRoutineIdentifierTable_31[RoutineHandle_0xFF0A]
        .DcmDspRoutineInfoRef.DcmDspStartRoutineOut.DcmDspRoutineSignalLength;
    DsdInternal_ProcessingDone(pMsgContext);
}
#endif
...
void App_WriteAddress(Dcm_MsgContextType *pMsgContext) {
    ...
    if (App_WriteAddressCounter == 0) {
        ...
        /* Calculate size */
        for (i = 0; i < gMemorySizeFormat; i++) {
            memorySize |= (uint32)(pMsgContext->reqData[2 + gMemoryAddressFormat + i])
                << (uint8)(8 * (gMemorySizeFormat - 1 - i));
        }
    } else {
    }
 ...
 ******************************************************************************/
FUNC(void, DCM_CODE)
App_DTCRecordOn(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    (void)pMsgContext;
    gDTCSwitch = 1;
    dtconflag();
    dem_enable_dtc_setting();
...
/******************************************************************************
     ...
     ******************************************************************************/
FUNC(void, DCM_CODE)
App_DTCRecordOff(P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext) {
    (void)pMsgContext;
    gDTCSwitch = 0;
    dtcoffflag();
